...
final bookmarkViewModelProvider = Provider<BookmarkViewModel>((ref) => BookmarkViewModel());
  ...
  List<BookmarkModel> getBookmarkedItems() {
    return [
      BookmarkModel(
        ...
        description: 'Phasellus interdum neque nunc, non tempor dui auctor eu. Mauris tincidunt tincidunt odio, eu elementum tellus. Curabitur blandit nisl sit amet mauris finibus.',
        views: 25900,
        comments: 657,
      ),
      BookmarkModel(
