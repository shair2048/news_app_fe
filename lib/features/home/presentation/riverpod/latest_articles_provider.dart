...
import 'package:news_app_fe/features/home/presentation/riverpod/latest_articles_notifier.dart';
...
final latestArticlesProvider =
    AsyncNotifierProvider<LatestArticlesNotifier, List<Article>>(
      () => LatestArticlesNotifier(),
    );
