...
class NewsViewModel {
  NewsModel getNewsDetail() {
    return NewsModel(
      title: 'How to Become an Interior Designer (and What You Need to Know Before You Do)',
      imageUrl: 'assets/icons/avatar.svg',
      authorName: 'John Doe',
      authorImage: 'assets/icons/avatar.svg',
      publishedDate: 'July 10, 2025',
      content: 'What is an Interior Designer? Donec at elit a sem tincidunt interdum in sed quam. In fringilla, massa eget sagittis viverra, sapien tellus mollis libero, nec ullamcorper purus quam ac turpis. '
